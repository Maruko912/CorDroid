...
model = Word2Vec.load(r'.\fcg\fun2vec_model\senfun2vecModel\fun2vec')
...
def extract_task(dst_output_abs_path):
    ...
    all_funs_path = os.path.join(dst_output_abs_path, 'sen_all_fun.txt')
    node_features_path = os.path.join(dst_output_abs_path, 'sen_node_features.npy')
    # print(all_funs_path)
